...
Future<Uint8List> generatePdf(OrderModel orderModel) async {
  ...
  pw.Page page = pw.Page(
    build: (context) {
      pdf.PdfColor kPrimary =
          pdf.PdfColor.fromInt(KConstants.kPrimary100.value);
      pdf.PdfColor textColor50 =
          pdf.PdfColor.fromInt(KConstants.textColor50.value);
                      ...
                      child: pw.Row(
                        children: [
                          pw.Container(
                            ...
                            child: pw.Image(
                              pw.MemoryImage(prodImages[index]),
